  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="cpamainApp.division.home.createOrEditLabel" data-cy="DivisionCreateUpdateHeading">
            <Translate contentKey="cpamainApp.division.home.createOrEditLabel">Create or edit a Division</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('cpamainApp.division.name')}
                id="division-name"
                name="name"
                data-cy="name"
                type="text"
