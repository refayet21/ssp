...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './entry-log.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENTRYLOG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ENTRYLOG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ENTRYLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ENTRYLOG actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ENTRYLOG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ENTRYLOG actions', async () => {
      const arg = 42666;
