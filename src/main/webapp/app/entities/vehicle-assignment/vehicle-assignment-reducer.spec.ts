...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './vehicle-assignment.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLEASSIGNMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLEASSIGNMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLEASSIGNMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLEASSIGNMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLEASSIGNMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLEASSIGNMENT actions', async () => {
      const arg = 42666;
