...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESIGNATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DESIGNATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DESIGNATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DESIGNATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DESIGNATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DESIGNATION actions', async () => {
      const arg = 42666;
