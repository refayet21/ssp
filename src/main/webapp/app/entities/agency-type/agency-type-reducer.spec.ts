...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENCYTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENCYTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENCYTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AGENCYTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENCYTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENCYTYPE actions', async () => {
      const arg = 42666;
