...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENCYLICENSE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENCYLICENSE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENCYLICENSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AGENCYLICENSE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENCYLICENSE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENCYLICENSE actions', async () => {
      const arg = 42666;
