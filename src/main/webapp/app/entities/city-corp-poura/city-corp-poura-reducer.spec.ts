...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CITYCORPPOURA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CITYCORPPOURA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CITYCORPPOURA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CITYCORPPOURA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CITYCORPPOURA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CITYCORPPOURA actions', async () => {
      const arg = 42666;
