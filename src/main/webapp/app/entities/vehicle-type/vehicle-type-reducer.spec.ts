...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VEHICLETYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VEHICLETYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VEHICLETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_VEHICLETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_VEHICLETYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VEHICLETYPE actions', async () => {
      const arg = 42666;
