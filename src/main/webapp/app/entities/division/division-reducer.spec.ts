...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './division.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DIVISION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DIVISION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DIVISION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DIVISION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DIVISION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DIVISION actions', async () => {
      const arg = 42666;
