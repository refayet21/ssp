...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './zone.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ZONE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ZONE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ZONE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ZONE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ZONE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ZONE actions', async () => {
      const arg = 42666;
