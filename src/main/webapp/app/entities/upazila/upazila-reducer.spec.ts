...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './upazila.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UPAZILA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UPAZILA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UPAZILA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UPAZILA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UPAZILA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UPAZILA actions', async () => {
      const arg = 42666;
