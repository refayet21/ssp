...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './rmo.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RMO_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RMO actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RMO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RMO actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RMO actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RMO actions', async () => {
      const arg = 42666;
