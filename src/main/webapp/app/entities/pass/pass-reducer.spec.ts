...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pass.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PASS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PASS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PASS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PASS actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PASS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PASS actions', async () => {
      const arg = 42666;
