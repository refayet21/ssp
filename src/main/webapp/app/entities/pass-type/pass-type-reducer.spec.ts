...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './pass-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PASSTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PASSTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PASSTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PASSTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PASSTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PASSTYPE actions', async () => {
      const arg = 42666;
