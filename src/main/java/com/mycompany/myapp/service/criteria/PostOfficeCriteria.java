...
/**
 * Criteria class for the {@link com.mycompany.myapp.domain.PostOffice} entity. This class is used
 * in {@link com.mycompany.myapp.web.rest.PostOfficeResource} to receive all the possible filtering options from
...
public class PostOfficeCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, code, addressId, districtId, distinct);
    }
