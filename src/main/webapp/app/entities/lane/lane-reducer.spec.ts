...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './lane.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LANE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LANE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LANE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LANE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LANE actions', async () => {
      const arg = 42666;
