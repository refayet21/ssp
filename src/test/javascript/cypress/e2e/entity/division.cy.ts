...
describe('Division e2e test', () => {
  ...
  const divisionSample = { name: 'humiliating' };
  ...
  describe('Division page', () => {
    ...
    describe('with existing value', () => {
      ...
      it('last delete button click should delete instance of Division', () => {
        cy.intercept('GET', '/api/divisions/*').as('dialogDeleteRequest');
  ...
  describe('new Division page', () => {
    ...
    it('should create an instance of Division', () => {
      cy.get(`[data-cy="name"]`).type('sometimes but avail');
      cy.get(`[data-cy="name"]`).should('have.value', 'sometimes but avail');
