...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './union.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UNION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UNION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UNION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UNION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UNION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UNION actions', async () => {
      const arg = 42666;
