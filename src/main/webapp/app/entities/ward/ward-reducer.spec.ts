...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ward.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_WARD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_WARD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_WARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_WARD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_WARD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_WARD actions', async () => {
      const arg = 42666;
