...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_POSTOFFICE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_POSTOFFICE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_POSTOFFICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_POSTOFFICE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_POSTOFFICE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_POSTOFFICE actions', async () => {
      const arg = 42666;
