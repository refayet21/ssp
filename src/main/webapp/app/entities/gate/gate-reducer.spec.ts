...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './gate.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_GATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_GATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GATE actions', async () => {
      const arg = 42666;
