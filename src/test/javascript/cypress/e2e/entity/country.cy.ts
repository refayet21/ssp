...
describe('Country e2e test', () => {
  ...
  describe('new Country page', () => {
    ...
    it('should create an instance of Country', () => {
      cy.get(`[data-cy="name"]`).type('override');
      cy.get(`[data-cy="name"]`).should('have.value', 'override');

      cy.get(`[data-cy="isoCode"]`).type('cheque midst yuck');
      cy.get(`[data-cy="isoCode"]`).should('have.value', 'cheque midst yuck');
