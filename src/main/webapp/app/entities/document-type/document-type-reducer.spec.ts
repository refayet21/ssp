...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTTYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCUMENTTYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCUMENTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_DOCUMENTTYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTTYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCUMENTTYPE actions', async () => {
      const arg = 42666;
