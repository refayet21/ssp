...
export const ZoneDeleteDialog = () => {
  ...
  const confirmDelete = () => {
    dispatch(deleteEntity(zoneEntity.id));
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="cpamainApp.zone.delete.question">
        <Translate contentKey="cpamainApp.zone.delete.question" interpolate={{ id: zoneEntity.id }}>
