...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './agency.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENCY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENCY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENCY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AGENCY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENCY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENCY actions', async () => {
      const arg = 42666;
