...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACCESSPROFILE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACCESSPROFILE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACCESSPROFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACCESSPROFILE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACCESSPROFILE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACCESSPROFILE actions', async () => {
      const arg = 42666;
