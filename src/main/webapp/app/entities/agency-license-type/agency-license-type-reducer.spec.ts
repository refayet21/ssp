...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './agency-license-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENCYLICENSETYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENCYLICENSETYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENCYLICENSETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AGENCYLICENSETYPE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENCYLICENSETYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENCYLICENSETYPE actions', async () => {
      const arg = 42666;
